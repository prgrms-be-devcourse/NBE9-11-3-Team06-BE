...
@MustBeDocumented
@ApiResponse(
    responseCode = "400", description = "타임블록 데이터 없음 (TIMETABLE-001)", content = [Content(
        mediaType = "application/problem+json",
        schema = Schema(ref = "#/components/schemas/ProblemDetail"),
        examples = [ExampleObject(
            name = "noTimeBlocks", value = """
...
@ApiResponse(
    responseCode = "404", description = "모임 조회 실패 (MEETING-001)", content = [Content(
        mediaType = "application/problem+json",
        schema = Schema(ref = "#/components/schemas/ProblemDetail"),
        examples = [ExampleObject(
...
annotation class TimeTableErrorResponses 