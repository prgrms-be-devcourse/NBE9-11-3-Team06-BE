 ...
 * 다른 인증 필요 엔드포인트는 [AuthErrorResponses] 를 사용하세요.
 * 
 * 
...
@MustBeDocumented
@ApiResponse(
    responseCode = "401", description = "로그인 실패: 이메일 또는 비밀번호 불일치 (AUTH-004)", content = [Content(
        mediaType = "application/problem+json",
        schema = Schema(ref = "#/components/schemas/ProblemDetail"),
        examples = [ExampleObject(
            name = "invalidCredentials", value = """
                            {
...
annotation class AuthSpecificErrorResponses 