...
import com.back.nbe9112team06.global.springDoc.example.ParticipantApiExamples
...
class ParticipantController(
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        ...
        content = [Content(
            ...
            examples = [ExampleObject(name = "success", value = ParticipantApiExamples.JOIN_MEETING_SUCCESS_JSON)]
        )]
    )
    fun joinMeeting(
